...
async function enumerate() {
  ...
  if (!groupByColumn.value) {
    addLog("Please select a column to group by", 'warning');
    return;
  }
...
<template>
  <div class="flex flex-col h-full overflow-hidden">
      ...
      <div class="flex flex-col gap-4">
        <SiliconeCard>
          ...
          <div class="flex gap-4 mb-4">
            ...
            <div class="flex-1">
              ...
              <SiliconeTooltip content="Only set it to True when the file is sorted">
                <div class="mode-toggle">
                  <span v-for="item in sortedOpts" :key="String(item.value)" class="mode-item mx-1 w-24"
          ...
          <div class="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
            ...
            <div class="text-xs text-blue-700 dark:text-blue-300 font-mono bg-white dark:bg-gray-700 p-2 rounded">
        ...
        <SiliconeCard>
          ...
          <div class="flex flex-col gap-2">
            ...
            <SiliconeText type="info">2. Enter the index column name for the enumeration</SiliconeText>
            <SiliconeText type="info">3. Select a column to group by</SiliconeText>
            <SiliconeText type="info">4. Set whether the file is already sorted</SiliconeText>
            <SiliconeText type="info">5. Review the preview to confirm the SQL-like expression</SiliconeText>
            <SiliconeText type="info">6. Click
              <Icon icon="ri:play-large-line" class="w-4 h-4 inline align-middle" /> to start the enumerate by group
              process
            </SiliconeText>
    ...
    <SiliconeDialog v-model="dialog" title="Enumerate by Group - Add row numbers within each group (SQL ROW_NUMBER)"
      width="70%">
