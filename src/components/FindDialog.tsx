...
interface FindDialogProps {
  ...
  onConfirm: (type: "visible" | "all") => void;
}

export default function FindDialog({ open, onOpenChange, searchQuery, caseSensitive, useRegex, loading, onSearchQueryChange, onCaseSensitiveChange, onUseRegexChange, onConfirm }: FindDialogProps) {
