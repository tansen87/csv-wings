...
const ScrollArea = React.forwardRef(({ className, children, onScroll, ...props }, ref) => (<ScrollAreaPrimitive.Root ref={ref} className={cn("relative overflow-hidden", className)} onScroll={onScroll} {...props}>
